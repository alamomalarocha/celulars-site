...
Documents visual assets added during the full site visual review.

All files below are local project assets stored under `assets/images/iphones/`.

## Assets

| File | Format | Size | Source | Used On | Alt Text | License / Use Note |
|---|---:|---:|---|---|---|---|
| `iphone-17-pro-max-silver.webp` | WebP | 7 KB | Existing CDVS production asset derived from `production-models/iphone-17-pro-max/exports/silver/iphone-17-pro-max-silver.png` | Home, iPhones, Atacado | `iPhone 17 Pro Max em acabamento Silver`, `iPhone 17 Pro Max Silver` | Local project product reference. Does not imply Apple partnership or authorization. |
...
- Do not use Apple logos as CELULARS branding.
