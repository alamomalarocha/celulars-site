(function clientMain(){
  ...
  function genericMessageFor(m){return'Olá, tenho interesse no '+m.model_name+' pela CELULARS. Gostaria de confirmar capacidades, cores, condição eCPO ou Novo, preço final e condições de compra.'}
