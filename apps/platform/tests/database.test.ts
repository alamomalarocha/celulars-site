...
test('migration and seed create a complete isolated DEMO database', () => {
  ...
  try {
    assert.deepEqual(migrateDatabase(database), ['001_initial.sql', '002_governance.sql', '003_identity.sql', '004_documents.sql', '005_integrations.sql', '006_inbox.sql', '007_aftersales.sql']);
