...
const mutableTables = [
  'inventory_movement_details', 'return_history', 'return_items', 'return_requests', 'inbox_history', 'inbox_cases', 'inbound_webhooks', 'delivery_outbox', 'delivery_templates', 'documents',   'mfa_recovery_codes', 'mfa_credentials', 'team_members', 'teams', 'user_consents', 'terms_versions', 'account_tokens', 'user_invitations',
